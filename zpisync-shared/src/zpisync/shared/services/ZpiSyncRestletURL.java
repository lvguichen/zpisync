...
public class ZpiSyncRestletURL {

	private static final Logger log = Logger.getLogger(ZpiSyncRestletURL.class.getName());

	public static void main(String[] args) throws Exception {

		ZpiSyncRestletURL service = new ZpiSyncRestletURL();
